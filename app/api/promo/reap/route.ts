 ...
 * раз в сутки (vercel.json), защищён CRON_SECRET. Чаще нельзя: план Hobby
 * разрешает только суточное расписание, деплой с четвертьчасовым кроном
 * отклоняется целиком.
 * На платном плане расписание можно ужать, возврат станет быстрее.
 *
