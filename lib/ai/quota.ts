...
/** Что именно просят. Мокапы мерча рисуются локально и квоту не тратят. */
export type AiFeature = 'promoShots' | 'merchMockups'

/** Цена обращения в квоте. Ноль значит «Pro нужен, а счётчик не трогаем». */
