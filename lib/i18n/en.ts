...
const en: Record<keyof typeof ru, string> = {
  ...
  'auth.loginSubtitle': 'The studio opens with an account: sign in to get back to your projects',
  ...
  'projects.errorInvalid': 'The project failed validation and was not saved',
  ...
  'help.editor.body': 'This is the end grain of the future board: every cell is the end of a stick, not paint on a surface. Click a cell to paint it with the selected species. If the new species breaks a shared panel, the studio offers to split it in two and counts the extra glue-up honestly.',
  ...
  'help.templates.body': 'Templates are ready, proven patterns: checkerboard, stripes, herringbone. They are a good starting point, and you change species and sizes afterwards to fit your stock. If the editor already holds your edits, the studio asks before replacing the design.',
  ...
  'landing.patterns.body':
    'A library of patterns for every taste, from strict geometry to intricate mosaics. Pick one, tune the species and sizes to your stock, and the engine works out the cuts right away.',
